...
export const horizontalMenuItems = [ 
    ...
    new Menu (101, 'RENTAL', null, null, null, true, 0),
    new Menu (3, 'RESALE',null, 'https://preownedproperties.in/', 'blank', false, 0), 
    new Menu (60, 'NAV.CONTACT', '/contact', null, null, false, 0),  
    new Menu (70, 'NAV.ABOUT_US', '/about', null, null, false, 0), 
    
    new Menu (4, 'COMMERCIAL','/properties', null, null, false, 101),
    new Menu (5, 'residential','/properties', null, null, false, 101),
    ...
    // new Menu (40, 'Property Section', null, null, null, true, 0),   
